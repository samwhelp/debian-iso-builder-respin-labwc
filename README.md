...
# debian-iso-builder-respin-labwc
...
| `+` | `+` |
| [debian-iso-builder-remix-labwc](https://samwhelp.github.io/debian-iso-builder-remix-labwc/) | [GitHub](https://github.com/samwhelp/debian-iso-builder-remix-labwc) |
| `=` | `=` |
| [debian-iso-builder-respin-labwc](https://samwhelp.github.io/debian-iso-builder-respin-labwc/) | [GitHub](https://github.com/samwhelp/debian-iso-builder-respin-labwc) |
...
| Config |
| ------ |
| [~/.config](https://github.com/samwhelp/debian-iso-builder-respin-labwc/tree/main/template/asset/overlay/etc/skel/.config) |
| [/usr/share/glib-2.0/schemas](https://github.com/samwhelp/debian-iso-builder-respin-labwc/tree/main/template/asset/overlay/usr/share/glib-2.0/schemas) |
| [/etc/dconf/db/distro.d](https://github.com/samwhelp/debian-iso-builder-respin-labwc/tree/main/template/asset/overlay/etc/dconf/db/distro.d) |
...
> clone [debian-iso-builder-respin-labwc](https://github.com/samwhelp/debian-iso-builder-respin-labwc)

``` sh
git clone https://github.com/samwhelp/debian-iso-builder-respin-labwc.git
```


> change dir to `debian-iso-builder-respin-labwc`

``` sh
cd debian-iso-builder-respin-labwc
```
...
> The resulting ISO file will be placed on `debian-iso-builder-remix-labwc/dist`
